 ...
 * @notice Helper library for ERC-4337 Account Abstraction validation data operations
 */
library ValidationHelper {
    ...
    function _intersectTimeRange(uint256 validationData, uint256 paymasterValidationData) internal pure returns (ValidationData memory intersectedData) {
